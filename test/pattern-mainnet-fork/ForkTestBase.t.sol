...
contract ForkTestBase is DssTest {
    ...
    address constant PATTERN_PROXY  = Ethereum.PATTERN_PROXY;
    ...
    function setUp() public virtual {
        ...
        AllocatorIlkConfig memory ilkConfig = AllocatorIlkConfig({
            ...
            gap            : 10_000_000 * RAD,
            ttl            : 6 hours,
            allocatorProxy : Ethereum.PATTERN_PROXY,
        ...
        // Step 5: Initialize through Pattern governance (Pattern spell payload)
